                ...
                <div class="banner" >
                    <ul>
                        ...
                        ="width: 100%; height: 100%; overflow: hidden; z-index: 18; visibility: hidden; opacity: 0;">
                            ...
                            ="undefined" data-zoomstart="undefined" data-zoomend="undefined" data-
                            ="undefined" data-rotationend="undefined" data-ease="undefined" data-bgpositionend
                            ="undefined" data-bgposition="undefined" data-kenburns="undefined" data-easeme
                            ="undefined" data-bgfit="undefined" data-bgfitend="undefined" data-
                            ="undefined" data-oheight="undefined">
                                <div class="tp-bgimg defaultimg" data-lazyload="undefined" data-bgfit="cover"
                                     data-bgposition="center center" data-bgrepeat="no-repeat" data-lazydone
                                     ="undefined" src="source/image/slide/{{$sl->image}}" data-src
                                     ="source/image/slide/{{$sl->image}}" style="background-color: rgba(0, 0, 0, 0);
                                     background-repeat: no-repeat; background-image: url('source/image/slide/{{$sl->image}}');
                        ...
                        <div class="row">
                            @foreach($sanpham_khuyenmai as $khuyenmai)
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        <div class="single-item-header">
                                            <a href="chi-tiet-san-pham/{{$khuyenmai->id}}"><img src="source/image/product/{{$khuyenmai->image}}" alt="" height="250px"></a>
                                        </div>

                                        <div class="single-item-body">
                                            <p class="single-item-title">{{$khuyenmai->name}}</p>
                                            <p class="single-item-price">
                                                <span class="flash-del">{{$khuyenmai->unit_price}}</span>
                                                <span class="flash-sale">{{$khuyenmai->promotion_price}}</span>
                                            </p>
                                        </div>
                                        <div class="single-item-caption">
